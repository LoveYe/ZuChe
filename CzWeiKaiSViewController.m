...
@interface CzWeiKaiSViewController()<UIAlertViewDelegate,MAMapViewDelegate,AMapLocationManagerDelegate>{
...
@implementation CzWeiKaiSViewController
...
- (void)setTimestamp:(NSInteger)timestamp{
    ...
    if (_timestamp != 0) {
        _wksTimer =[NSTimer scheduledTimerWithTimeInterval:1 target:self selector:@selector(timer:) userInfo:nil repeats:YES];
    }
}
