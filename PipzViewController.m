...
@interface PipzViewController()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate,MAMapViewDelegate,AMapLocationManagerDelegate>{
...
@implementation PipzViewController
