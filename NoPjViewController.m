...
@interface NoPjViewController()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate,MAMapViewDelegate,AMapLocationManagerDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,toushuDelgate,UIActionSheetDelegate,VPImageCropperDelegate>{
...
@implementation NoPjViewController
...
-(void)refreshClick1:(UIRefreshControl *)refreshContro {
  ...
  //  [self shuaxinzhuangtaifanhui];
}


- (void)shuaxinzhuangtaifanhui{
    
    UIView *shuaxin = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight)];
    shuaxin.backgroundColor = [UIColor colorWithWhite:0.f alpha:0.5];
    shuaxin.tag = 999;
    [self.view.window addSubview:shuaxin];
    ...
    [queding addTarget:self action:@selector(shuaxindingdan) forControlEvents:UIControlEventTouchUpInside];
...
-(void)shuaxindingdan {
    ...
    UIView *view = [self.view.window viewWithTag:999];
...
//    
//        button.frame = CGRectMake(width*0.9/4,width*0.13,width*0.9/4, width*0.9/4*2/3);
//        
//    }
...
//        
//        button.frame = CGRectMake(width*0.9/4*2,width*0.13,width*0.9/4, width*0.9/4*2/3);
//    }
...
//        
//        button.frame = CGRectMake(width*0.9/4*3,width*0.13,width*0.9/4, width*0.9/4*2/3);
//    }
//
