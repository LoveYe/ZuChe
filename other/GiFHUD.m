...
#define Size            Height(100)
#define FadeDuration    0.3
#define GifSpeed        0.01
...
//-APPDELEGATE.window.frame.size.width*0.05
    if ((self = [super initWithFrame:CGRectMake(APPDELEGATE.window.frame.size.width/2-Height(38),APPDELEGATE.window.frame.size.height/2,Height(188/1.6-40),Height(188/1.6-40))])) {
...
//        [self setCenter:APPDELEGATE.window.center];
        ...
        [self.layer setBackgroundColor:[[UIColor colorWithWhite:1 alpha:1] CGColor]];
        [self.layer setCornerRadius:15];
        [self.layer setMasksToBounds:YES];
        
        self.imageView = [[UIImageView alloc] initWithFrame:CGRectInset(self.bounds, Height(10), Height(10))];
...
//        UIColor *beijing=Color(228, 228, 228)
