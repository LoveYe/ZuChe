...
@implementation WSStarRatingView1
...
- (void)commonInit
{
    self.starBackgroundView = [self buidlStarViewWithImageName:kBACKGROUND_STAR1];
    self.starForegroundView = [self buidlStarViewWithImageName:kFOREGROUND_STAR1];
