...
@implementation DetailsCarXclTableViewCell {
...
//    _scoreLabel.font = [UIFont systemFontOfSize:13];
    ...
    __block DetailsCarXclTableViewCell *detaCell = self;
...
-(void)receiveButtonClick:(UIButton *)butto {
    ...
    if (butto.tag == 10001) {
        [self callPhone:_plane_name[@"tel"]];
    }
...
-(void)callPhone:(NSString *)phoneNum {
    ...
    NSString *compare = [[UIDevice currentDevice] systemVersion];
    if ([compare compare:@"10.2" options:NSNumericSearch] == NSOrderedDescending || [compare compare:@"10.2" options:NSNumericSearch] == NSOrderedSame)
    {
