...
@interface NoStartViewController()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate,MAMapViewDelegate,AMapLocationManagerDelegate>{
...
@implementation NoStartViewController
...
- (void)setTimestamp:(NSInteger)timestamp{
    ...
    if (_timestamp != 0) {
        _noStartTimer =[NSTimer scheduledTimerWithTimeInterval:1 target:self selector:@selector(timer:) userInfo:nil repeats:YES];
    }
}
