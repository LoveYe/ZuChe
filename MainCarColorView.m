...
@interface MainCarColorView()<UIPickerViewDelegate,UIPickerViewDataSource>{
...
@implementation MainCarColorView
...
{
    MainCarColorView *mview = [[self alloc]initWithFrame:frame];
