...
//    UIImageView *view = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.chooseTimeLabel.bottom, self.dateView.size.width*4/7, self.dateView.size.height-H(160))];
//   
