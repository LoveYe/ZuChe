...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.layerFillColor = [UIColor colorWithRed:1/256.0 green:1/256.0 blue:1/256.0 alpha:0.5];
        self.layerBoardColor = [UIColor clearColor];
        self.speraLineColor = [UIColor clearColor];
        self.perfectNumber = 100.0;
        self.descTextFont = [UIFont fontWithName:@"Helvetica-BoldOblique" size:15];
        self.descTextColor = [UIColor clearColor];
    }
...
- (void)drawBaseView{
    for (NSInteger i = self.baseDrawPointArray.count-1; i>=0; i--) {
        ...
        shapeLayer.fillColor = [UIColor colorWithWhite:0 alpha:0].CGColor;
...
- (void)drawValueView{
    ...
    for (NSInteger i = 0 ; i<self.drawPointArray.count; i++) {
        ...
        UIColor *cacheColor = [UIColor redColor];
        ...
        if (self.valueBoardColorArray.count>i) {
            ...
            cacheColor = [UIColor redColor];
        }
        shaper.strokeColor = [UIColor clearColor].CGColor;
