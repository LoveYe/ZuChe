...
- (void)layoutSubviews{
    ...
    for (NSInteger index = 0; index < self.separateLabelArrM.count ; index ++) {
        ...
        separateLabel.font = [UIFont systemFontOfSize:25];
    }
    
    self.dayLabel.backgroundColor = [UIColor colorWithRed:229/255.0 green:229/255.0 blue:229/255.0 alpha:1];
    self.hourLabel.backgroundColor = [UIColor colorWithRed:229/255.0 green:229/255.0 blue:229/255.0 alpha:1];
    self.minuesLabel.backgroundColor = [UIColor colorWithRed:229/255.0 green:229/255.0 blue:229/255.0 alpha:1];
    self.secondsLabel.backgroundColor = [UIColor colorWithRed:229/255.0 green:229/255.0 blue:229/255.0 alpha:1];
    
    self.dayLabel.font = [UIFont systemFontOfSize:20];
    self.hourLabel.font = [UIFont systemFontOfSize:20];
    self.minuesLabel.font = [UIFont systemFontOfSize:20];
    self.secondsLabel.font = [UIFont systemFontOfSize:20];
