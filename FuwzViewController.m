...
@interface FuwzViewController()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate,MAMapViewDelegate,AMapLocationManagerDelegate,toushuDelgate>{
...
@implementation FuwzViewController
