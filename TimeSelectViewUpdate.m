...
@interface TimeSelectViewUpdate()<UIPickerViewDataSource,UIPickerViewDelegate>{
...
@implementation TimeSelectViewUpdate
...
{
    TimeSelectViewUpdate *mview = [[self alloc]initWithFrame:frame];
