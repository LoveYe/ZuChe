...
//        self.bezelView.style = MBProgressHUDBackgroundStyleSolidColor;
        ...
        self.activityIndicatorColor = [UIColor colorWithRed:7/255.0 green:187/255.0 blue:177/255.0 alpha:1];
        self.xOffset = 0.0f;
        self.yOffset = 0.0f;
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _progress = 0.f;
        _annular = NO;
        _progressTintColor = [[UIColor alloc] initWithWhite:0.f alpha:0.f];
        _backgroundTintColor = [[UIColor alloc] initWithWhite:0.f alpha:.0f];
        [self registerForKVO];
    }
    return self;
}
