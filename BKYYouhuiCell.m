...
- (void)reloadCell{
    ...
    backView.backgroundColor = Color(177, 177, 177);
...
- (void)layoutSubviews{
    ...
    time.frame = CGRectMake(backView.frame.size.width*0.03, CGRectGetMaxY(quan.frame)+width*0.02, backView.frame.size.width/3*2+width*0.05, backView.frame.size.height/4-width*0.01);
    
    jiage.frame = CGRectMake(CGRectGetMaxX(quan.frame)-width*0.03, backView.frame.size.height/2-width*0.1, width*0.265, width*0.2);
}
