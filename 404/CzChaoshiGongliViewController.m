...
@interface CzChaoshiGongliViewController()<UIAlertViewDelegate,MAMapViewDelegate,AMapLocationManagerDelegate,WB_StopWatchDelegate>{
...
@implementation CzChaoshiGongliViewController
...
-(void)creatzfdjfourView {
    UIView *fourView = [[UIView alloc] initWithFrame:CGRectMake(width*0.05, _scrollerContenHeight+width*0.04, 0.9*width, width*1.48+ScreenHeight*0.2)];
    //fourView.backgroundColor = [UIColor purpleColor];
    _scrollerContenHeight+= (width*1.48+ScreenHeight*0.2+width*0.04);
    ...
    NSInteger yufukuan  = [_detailsDict[@"xcxq"][@"chaogonglijiage"] integerValue];   // NSLog(@"%@",_detailsDict[@"xcxq"][@"jiage"]);
   ...
   // 845w+0.2h
    ...
    UILabel *duan = [[UILabel alloc] initWithFrame:CGRectMake(width/2-width*0.3-0.05*width,width*0.95+ScreenHeight*0.2+width*0.15, width*0.6, width*0.1)];
    ...
    UILabel *duan1 = [[UILabel alloc] initWithFrame:CGRectMake(width/2-width*0.3-0.05*width,width*1.2+ScreenHeight*0.2, width*0.6, width*0.1)];
    ...
    jieshu.frame = CGRectMake(-width*0.05, ScreenHeight*0.2+width*1.35, width, width*0.13);
