...
@interface MineDetailView ()<UITableViewDelegate,UITableViewDataSource,ZHPickViewDelegate,UIImagePickerControllerDelegate,PTXDatePickerViewDelegate,UINavigationControllerDelegate,MBProgressHUDDelegate,phoneNumberDelegate>{
...
@property (nonatomic, strong) NSDate *selectedDate;@end
...
- (void)fanhuiAction{
    ...
    MineController *view = [[MineController alloc] init];
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                if ([s isEqualToString:@""]) {
                    ...
                    //                    image.image = [UIImage imageNamed:@"头像.png"];
