...
@interface CzWdaoDaViewController()<UIAlertViewDelegate,MAMapViewDelegate,AMapLocationManagerDelegate,MBSliderViewDelegate>{
...
@implementation CzWdaoDaViewController
...
-(void)creatzfdjfourView {
    ...
    _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(width*0.9/2-30, width*0.55 +width*0.1,60, width*0.1)];
    ...
    _MBSlider = [[MBSliderView alloc] initWithFrame:CGRectMake(-width*0.05, width*1.04+width*0.1, width, 44)];
