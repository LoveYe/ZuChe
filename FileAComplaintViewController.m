...
@interface FileAComplaintViewController ()<UIScrollViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextViewDelegate>{
...
@implementation FileAComplaintViewController
...
-(void)creatScrollerView {
    ...
    _scollerView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, HEIGHT-64)];
