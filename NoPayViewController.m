...
@interface NoPayViewController()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate,MAMapViewDelegate,AMapLocationManagerDelegate,addressDelgate>{
...
//    NSString *a = _detailsDict[@"xcxq"][@"zhifu_time"];
...
- (void)cuo:(UIButton *)sender{
    ...
    [queding setTitle:@"确定取消" forState:UIControlStateNormal];
    [queding addTarget:self action:@selector(QdqxButton:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [wZxx addTarget:self action:@selector(wozaixiangxiang:) forControlEvents:UIControlEventTouchUpInside];
