...
@interface CzYizhifuWkViewController()<UIAlertViewDelegate,MAMapViewDelegate,AMapLocationManagerDelegate>{
...
@implementation CzYizhifuWkViewController
...
-(void)creatzfdjfourView {
    ...
    [greenButton setTitle:@"已支付尾款" forState:UIControlStateNormal];
