...
- (void)viewDidLoad {
    ...
    [self tableViews];
    NSDictionary *dict =[NSDictionary dictionaryWithObjectsAndKeys:@"1",@"model", nil];
...
//        [imageView sd_setImageWithURL:[[_listArray objectAtIndex:indexPath.row] objectForKey:@"image"] placeholderImage:[UIImage imageNamed:@"placeholder_100x100@2x.png"]];
        ...
        {
            xian.frame=CGRectMake(ScreenWidth*0.04, ScreenWidth*0.13-1, ScreenWidth-ScreenWidth*0.08, 1);
