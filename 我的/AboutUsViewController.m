...
- (void)viewDidLoad {
    ...
    UIImageView *image =[[UIImageView alloc]initWithFrame:CGRectMake(ScreenWidth*0.1,0, ScreenWidth*0.8, ScreenWidth*0.8)];
    ...
    label.frame = CGRectMake(ScreenWidth/2-ScreenWidth*0.275, CGRectGetMaxY(gongzhonghao.frame)+ScreenWidth*0.06, ScreenWidth*0.55, ScreenWidth*0.07);
    ...
    UILabel *compinity = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth*0.1, ScreenHeight-ScreenWidth*0.3, ScreenWidth*0.8, ScreenWidth*0.1)];
