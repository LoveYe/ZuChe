//
//  IndividualitySignViewController.m
//  ZuChe
//
...
@interface IndividualitySignViewController ()<UITextViewDelegate,UIAlertViewDelegate>
{
    UILabel*label;
    NSTimer *myTimer;
}
...
@implementation IndividualitySignViewController
...
{
    [super viewDidLoad];
    [self addTitleViewWithTitle:@"填写签名"];
...
- (void)qianming
{
    ...
    _textView.text =[ZCUserData share].descriptions;
...
-(void)tijiaoButton:(UIButton *)sender
{
    ...
    NSDictionary *parameter =[NSDictionary dictionaryWithObjectsAndKeys:[ZCUserData share].lianxi,@"lianxi", [ZCUserData share].userId,@"userid",[ZCUserData share].nickname,@"nickname",[ZCUserData share].xueli,@"xueli",[ZCUserData share].zhiye,@"zhiye",[ZCUserData share].xingqu,@"xingqu",string,@"description",nil];
