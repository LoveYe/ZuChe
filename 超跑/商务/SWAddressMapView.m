...
@interface SWAddressMapView ()<MAMapViewDelegate,AMapSearchDelegate, UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,AMapNaviCompositeManagerDelegate,AMapNaviDriveManagerDelegate,AMapNaviDriveViewDelegate>{
...
@implementation SWAddressMapView
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.endAddress isEqualToString:@"请点击添加"]) {
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(dituSendMessage:PriceTag:)]) {
            ...
            [_delegate dituSendMessage:addressStart PriceTag:0];
        }
