...
@interface ChangbaoViewController ()<UITableViewDataSource,UITableViewDelegate,YSLTransitionAnimatorDataSource,ShaiXuanDelegate,ChangBaoDelegate>{
...
@implementation ChangbaoViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ChangBaoViewCell *cell = [tableView dequeueReusableCellWithIdentifier:stac];
    if (!cell) {
        
        cell = [[ChangBaoViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:stac];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ChangbaoDetailView *view = [[ChangbaoDetailView alloc] init];
    NSDictionary *dict = _dataArray[indexPath.row];
    view.isOK = !isClick;
