...
@interface ChangbaoDetailView ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,YSLTransitionAnimatorDataSource,CarDetailDelegate>{
...
@implementation ChangbaoDetailView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ChangbaoDTCell *cell = [tableView cellForRowAtIndexPath:indexPath];
    
    if (!cell) {
        
        cell = [[ChangbaoDTCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:stac];
    }
