...
@interface ChaoPaoMapController ()<MAMapViewDelegate,AMapSearchDelegate,AMapLocationManagerDelegate, UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>{
...
@implementation ChaoPaoMapController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //    [self sendAddressString:[NSString stringWithFormat:@"%@",poi.address]];
