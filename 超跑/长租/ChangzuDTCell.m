...
- (void)customView{
    ...
    chaochu.text = [NSString stringWithFormat:@"超出： %@/公里",dict2[@"jiage3"]];
...
//    }
    ...
    ditu.frame = CGRectMake(0, CGRectGetMaxY(bigView1.frame), width, width*0.6);
        //        ditu.backgroundColor = [UIColor redColor];
...
-(UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSInteger)index reusingView:(UIView *)view{
    ...
    if (dict3.count == 0) {
        ...
        wuxiangsi.font = [UIFont boldSystemFontOfSize:18];
        ...
        __block ChangzuDTCell *detaCell = self;
...
- (void)Click1{
    ...
    if (_dicDelegate && [_dicDelegate respondsToSelector:@selector(pinglunUserID:)]) {
        
        [_dicDelegate pinglunUserID:dict[@"carid"]];
    }
}
