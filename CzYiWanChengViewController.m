...
@interface CzYiWanChengViewController()<UIAlertViewDelegate,MAMapViewDelegate,AMapLocationManagerDelegate,WB_StopWatchDelegate>{
...
@implementation CzYiWanChengViewController
...
-(void)creatzfdjfourView {
    ...
    [jieshu setTitle:@"已完成" forState:UIControlStateNormal];
